...
to the standard firmware delivered with the TD1202 module, with a
user extension.

Beside the AT command set supported by standard interpreter, the user
extension provides support for toggling the TD1202 EVB LED connected
to the TD1202 TIM2 pin, and to read both the chip temperature and
voltage.
