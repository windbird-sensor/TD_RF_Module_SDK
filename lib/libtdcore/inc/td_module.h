...
#define __ALIGN(i)              __do_not_use_align___use_pragma_data_alignment_egal_
#define __ALIGN2(i)

	/** Macro for RAM function declaration depending on the used compiler */
#define __RAMFUNCTION           __ramfunc

#define __BOOTFUNCTION          __RAMFUNCTION
#define __BOOTVARIABLE
#define __GET_MSP				0
...
#define __PACKED                __attribute__((packed))
	...
	/** Macro for aligning structure depending on the used compiler */
#define __ALIGN(i)              __do_not_use_align___use_pragma_data_alignment_egal_and_ALIGN2
#define __ALIGN2(i)              __attribute__((aligned(i)))
#define __GET_MSP				__get_MSP()
...
#define __SECT(x)           	__attribute__((section(".rodata."x)))
// Garbage collectable string (but can't be merged anymore by compiler)
// Use only for unique strings in project that can be remove by options (CONFIG_xxx) or not uses code
// This macro will not increase storage size
#define LGC(str) ({ static const char __str[] = str; __str; })
#else

#error Your compiler is unsupported!
...
#define REVISION_TD1508			31	///< Module TD1508, all revisions
...
#if MODULE_REVISION == REVISION_TD1508 || MODULE_REVISION == REVISION_REF_DESIGN_FCC || MODULE_REVISION == REVISION_REF_DESIGN_ETSI

/** Module P/N in decimal format */
#define IN1501                  1501

	/** Module P/N in string format */
#define	MODULE_PN               "IN1501"
...
#define	LFXTAL_P_PIN            17					/**< Positive 32768 Hz Crystal pin */
...
#define	LFXTAL_N_PIN            18					/**< Negative 32768 Hz Crystal pin */

#define	DAC0_PORT               gpioPortC           /**< Digital to Analog Converter 0 port */
#define	DAC0_BIT                12					/**< Digital to Analog Converter 0 bit */
#define	DAC0_MASK               (1 << DAC0_BIT)		/**< Digital to Analog Converter 0 mask */
#define	DAC0_PIN                46					/**< Digital to Analog Converter 0 pin */

#define	USR0_PORT               gpioPortC           /**< User GPIO 0 port */
#define	USR0_BIT                15					/**< User GPIO 0 bit */
#define	USR0_MASK               (1 << USR0_BIT)		/**< User GPIO 0 mask */
#define	USR0_PIN                49					/**< User GPIO 0 pin */
...
#define	USR2_PORT               gpioPortD           /**< User GPIO 2 port */
#define	USR2_BIT                1					/**< User GPIO 2 bit */
#define	USR2_MASK               (1 << USR2_BIT)		/**< User GPIO 2 mask */
#define	USR2_PIN                30					/**< User GPIO 2 pin */

#define	USR3_PORT               gpioPortD           /**< User GPIO 3 port */
#define	USR3_BIT                3					/**< User GPIO 3 bit */
#define	USR3_MASK               (1 << USR3_BIT)		/**< User GPIO 31 mask */
#define	USR3_PIN                32					/**< User GPIO 3 pin */

#define	USR4_PORT               gpioPortD           /**< User GPIO 4 port */
#define	USR4_BIT                0					/**< User GPIO 4 bit */
#define	USR4_MASK               (1 << USR4_BIT)		/**< User GPIO 4 mask */
#define	USR4_PIN                29					/**< User GPIO 4 pin */

#define	USR1_PORT               gpioPortD           /**< User GPIO 1 port */
#define	USR1_BIT                2					/**< User GPIO 1 bit */
#define	USR1_MASK               (1 << USR1_BIT)		/**< User GPIO 1 mask */
#define	USR1_PIN                31					/**< User GPIO 1 pin */
...
#define TX_PORT                 gpioPortC           /**< RS232 TX (Out) port */
#define TX_BIT                  6					/**< RS232 TX (Out) bit */
#define TX_MASK                 (1 << TX_BIT)		/**< RS232 TX (Out) mask */
#define TX_PIN                  38					/**< RS232 TX (Out) pin */

#define RX_PORT                 gpioPortC           /**< RS232 RX (In) port */
#define RX_BIT                  7					/**< RS232 RX (In) bit */
#define RX_MASK                 (1 << RX_BIT)		/**< RS232 RX (In) mask */
#define RX_PIN                  39					/**< RS232 RX (In) pin */
...
#define SDI_RF_PIN              0					/**< RF SPI MOSI (Out) pin */
...
#define SDO_RF_PIN              0					/**< RF SPI MISO (In) pin */
...
#define SCLK_RF_PIN             0					/**< RF SPI Clock (Out) pin */

#define NSEL_RF_PORT            gpioPortE           /**< RF Chip Select (Out) port */
#define NSEL_RF_BIT             9					/**< RF Chip Select (Out) bit */
#define NSEL_RF_MASK            (1 << NSEL_RF_BIT)	/**< RF Chip Select (Out) mask */
#define NSEL_RF_PIN             0					/**< RF Chip Select (Out) pin */
...
#define DB3_PIN                 50					/**< JTAG SWDCLK Clock (In) pin */
...
#define DB2_PIN                 51					/**< JTAG SWDIO Data I/O pin */
