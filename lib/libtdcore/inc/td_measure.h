...
extern "C" {
	 ...
	 *
	 * @note
	 *   This function is limited to positive temperature in degrees Celsius
	 *   only.
	 ...
	 *
	 * @note
	 *   This function returns voltages in a non-standard format and in tens of
	 *   mV, please consider using TD_MEASURE_VoltageExtended instead for values
	 *   directly in mV.
	 *
	 * @return
